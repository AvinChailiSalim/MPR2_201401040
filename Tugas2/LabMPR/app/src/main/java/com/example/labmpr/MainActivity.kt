...
class MainActivity : AppCompatActivity() {
    ...
    fun onClick(view: View){
        when(view.id){
            R.id.button -> {
                val intent = Intent(this@MainActivity, BestDeck::class.java);
            ...
            R.id.button2 -> {
                ...
                val intent = Intent(this@MainActivity, BestDeck::class.java)
                intent.putExtra(BestDeck.EXTRA_TEXT, text)
                startActivity(intent)
            }
            ...
            R.id.objectButton ->{
                ...
                val intent = Intent(this@MainActivity,BestDeck::class.java)
                intent.putExtra(BestDeck.EXTRA_CAR, carSpek)
                intent.putExtra(BestDeck.EXTRA_BOOL, true);
                startActivity(intent)
            }
        }
